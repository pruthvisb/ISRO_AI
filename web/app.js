...
// Initialize Quiz by fetching questions.json
async function fetchQuestionsAndInit() {
    try {
        ...
        console.warn("Could not load questions.json, falling back to offline templates.", e);
        quizBank = fallbackQuestions;
    }
    initQuiz();
    loadQuestion();
}
